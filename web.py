...
# --- Estilo TDR + nombre del archivo cargado en blanco ---
st.markdown("""
    <style>
    ...
    [data-testid="stFileUploader"] div[aria-label="uploaded file"] * {
        color: white !important;
        font-weight: bold;
    }
    </style>
...
# --- Título y Bienvenida ---
st.markdown("<h1 style='text-align: center; color: #002F6C;'>BIENVENIDO</h1>", unsafe_allow_html=True)
...
if vista == "Resumen por Flota":
    ...
    if df_filtrado["Unidad"].nunique() == 0:
        st.warning("⚠ No hay suficientes unidades seleccionadas para mostrar el gráfico.")
    else:
